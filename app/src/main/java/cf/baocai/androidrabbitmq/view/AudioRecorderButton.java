package cf.baocai.androidrabbitmq.view;
...
public class AudioRecorderButton extends androidx.appcompat.widget.AppCompatButton implements AudioManager.AudioStateListener {
    ...
    public AudioRecorderButton(Context context, AttributeSet attrs) {
        ...
        //TODO:要增加判断是否存在外部存储卡
        String dir= FileUtil.dirPath(context);
